             ...
             */
                ...
                try {
                    ...
                    while(Serverlistening) {
                        ...
                        // Reading responce from Client socket using BufferedReader

                        String response = "";
                        while ((response = in.readLine()) != null) {
                            Log.e("SERVER Recieved msg:", response);
                            publishProgress(response.trim());
                            // Publishing the response to OnProgressUpdate
                        }
                        // Closing BufferedReader and Socket
                        in.close();
                        Ssocket.close();
                    }
    ...
    private class ClientTask extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                // Creating a PrintWriter Object to send String Parameters recieved to ClientTask Async Thread
                PrintWriter out = new PrintWriter(Csocket.getOutputStream(),true);
                // Writing Data
                out.write(msgToSend.trim());

                Log.e("CLIENT msg sent:", msgToSend);

                // Closing buffer and client socket
                out.close();
                Csocket.close();
